...
namespace krkr
{
    namespace detail
    {
        // Custom exception type backing both narrow / wide error messages.
        // Message storage is a variant so the original encoding is preserved
        // end-to-end; no widening / narrowing conversion happens at throw site.
        // Deliberately does NOT inherit from std::exception: callers should
        // catch by the concrete type and use the typed message<T>() accessor.
        class exception
        {
        public:
